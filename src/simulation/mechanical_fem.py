...
def plate_deflection_fem(E: float, 
    ...
    """
    print("🔬 Running FEM plate deflection analysis (FEniCSx):")
    if FENICS_AVAILABLE:
        return solve_plate(E, nu, t, q_val, L, mesh_resolution)
    else:
        warnings.warn("FEniCSx not available. Install dolfinx via conda-forge.")
        return None
